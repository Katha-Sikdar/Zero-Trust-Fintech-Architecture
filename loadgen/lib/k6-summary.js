// Vendored copy of https://jslib.k6.io/k6-summary/0.0.1/index.js (Apache-2.0, k6 authors).
// Vendored deliberately: k6 resolves remote module specifiers at every run, so a
// sweep of hundreds of trials would abort mid-experiment on any DNS/network blip.
// Only change from upstream: CommonJS `exports.*` tail rewritten as ESM exports.
